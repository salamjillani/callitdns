...
import { Brain, Shield, Zap, Play, ChevronRight, CheckCircle } from 'lucide-react';
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-3xl font-bold text-white">Dotty AI Command</h2>
                </div>
                <p className="text-lg text-slate-300 mb-6">
                  Our revolutionary AI assistant understands natural language commands and automatically configures your DNS records perfectly every time.
                </p>
              ...
              <div className="bg-slate-800/50 rounded-lg p-6">
                <div className="font-mono text-sm">
                  ...
                  <p className="text-slate-300 mt-2">"Set up email for Gmail"</p>
          ...
          <div className="bg-slate-900/50 backdrop-blur-lg border border-slate-800 rounded-2xl p-12">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="order-2 md:order-1">
                <div className="bg-slate-800/50 rounded-lg p-6">
                  <h3 className="text-white font-semibold mb-4">Issues Detected:</h3>
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-red-400 mt-2"></div>
                      <div>
                        <p className="text-white font-medium">Missing SPF Record</p>
                        <p className="text-slate-400 text-sm">Email spoofing vulnerability detected</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-amber-400 mt-2"></div>
                      <div>
                        <p className="text-white font-medium">No DMARC Policy</p>
                        <p className="text-slate-400 text-sm">Email authentication incomplete</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="order-1 md:order-2">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-3xl font-bold text-white">AI Health Scan</h2>
                </div>
                <p className="text-lg text-slate-300 mb-6">
                  Our AI continuously monitors your DNS configuration for security vulnerabilities, performance issues, and best practice violations.
                </p>
                <ul className="space-y-3">
                  {[
              ...
              {[
                {
                  ...
                  description: 'Add your domain to CallitDNS with our simple setup wizard. We automatically import your existing records.'
                },
                {
                  step: 2,
                  title: 'Tell Dotty Your Goal',
                  description: 'Use natural language to describe what you want. Dotty understands commands like "Set up email for Gmail" or "Point to Shopify".'
                },
                {
                  step: 3,
                  title: 'Let AI Handle the Rest',
                  description: 'Dotty configures your DNS records automatically, monitors for issues, and keeps everything optimized 24/7.'
                }
              ].map((item) => (
