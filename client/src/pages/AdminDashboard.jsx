...
import { 
  Shield, User, FileText, LogOut, Plus, Edit2, Trash2, 
  Save, X, Eye, EyeOff, Calendar, Clock, Menu
} from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  const handleProfileUpdate = async (e) => {
    ...
    try {
      ...
      if (profileForm.email !== adminData.email && profileForm.currentPassword) {
      ...
      <div className="relative z-10 px-4 sm:px-6 py-6 sm:py-8">
        ...
        {activeTab === 'profile' && (
          <div className="bg-slate-900/50 backdrop-blur-lg border border-slate-800 rounded-xl p-4 sm:p-6 lg:p-8">
            <h2 className="text-xl sm:text-2xl font-bold text-white mb-4 sm:mb-6">Admin Profile</h2>
        ...
        {activeTab === 'blogs' && (
          <div className="bg-slate-900/50 backdrop-blur-lg border border-slate-800 rounded-xl p-4 sm:p-6 lg:p-8">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 space-y-4 sm:space-y-0">
              <h2 className="text-xl sm:text-2xl font-bold text-white">Blog Management</h2>
              <button
                onClick={() => {
                  setShowBlogForm(true);
                  setEditingBlog(null);
            ...
            <div className="space-y-4">
              {loading ? (
                ...
                blogs.map((blog) => (
                  <div key={blog.id} className="p-4 bg-slate-800/50 border border-slate-700 rounded-lg">
                    <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start space-y-4 lg:space-y-0">
                      <div className="flex-1">
                        <div className="flex flex-wrap items-center gap-2 mb-2">
                          <h3 className="text-base sm:text-lg font-semibold text-white">{blog.title}</h3>
                          {blog.featured && (
                        ...
                        <p className="text-slate-400 mb-3 text-sm sm:text-base">{blog.excerpt}</p>
