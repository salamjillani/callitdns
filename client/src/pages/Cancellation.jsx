...
import { XCircle, Calendar, Download, AlertTriangle, CreditCard } from 'lucide-react';
        ...
        <div className="bg-slate-900/50 backdrop-blur-lg border border-slate-800 rounded-xl p-8 space-y-8">
          <section>
            ...
            <p className="text-slate-300 mb-4">
              You can cancel your CallitDNS subscription at any time through your account dashboard:
            </p>
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-semibold text-white">When Cancellation Takes Effect</h2>
            </div>
          ...
          <section>
            ...
            <div className="space-y-4 text-slate-300">
              ...
              <ul className="list-disc list-inside space-y-2">
                <li><strong>30 days:</strong> Your DNS records remain active and accessible</li>
                <li><strong>60 days:</strong> Your account data is archived but recoverable</li>
                <li><strong>90 days:</strong> All data is permanently deleted</li>
              </ul>
              <div className="p-4 bg-amber-500/10 border border-amber-500/20 rounded-lg mt-4">
                <p className="text-amber-400">
                  <strong>Important:</strong> Export your DNS records before cancellation to avoid data loss.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-slate-300">
              ...
              <ul className="list-disc list-inside space-y-2">
                <li><strong>First-time subscribers:</strong> 30-day money-back guarantee</li>
                <li><strong>Annual plans:</strong> Pro-rated refund within first 30 days</li>
                <li><strong>Technical issues:</strong> Full refund if we cannot resolve service problems</li>
                <li><strong>Billing errors:</strong> Full refund for any overcharges</li>
              </ul>
              <p className="mt-4">
                To request a refund, contact our support team at{' '}
                <a href="mailto:billing@callitdns.com" className="text-amber-400 hover:text-amber-300">
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-semibold text-white">Before You Cancel</h2>
            </div>
            <div className="space-y-4 text-slate-300">
              <p>Please consider:</p>
              <ul className="list-disc list-inside space-y-2">
              ...
              <div className="mt-6 p-6 bg-slate-800/50 rounded-lg">
                ...
                <p className="mb-4">
                  Our team is here to help resolve any issues you're experiencing.
                </p>
          ...
          <section className="border-t border-slate-700 pt-8">
            <p className="text-slate-400 text-sm">
              This cancellation policy is part of our Terms of Service. 
              For questions, contact{' '}
              <a href="mailto:hello@callitdns.com" className="text-amber-400 hover:text-amber-300">
                hello@callitdns.com
              </a>
              {' '}or call{' '}
              <a href="tel:703-831-7181" className="text-amber-400 hover:text-amber-300">
                703-831-7181
              </a>.
            </p>
          </section>
