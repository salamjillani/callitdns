      ...
      <header className="sticky top-0 z-50 bg-slate-900/50 backdrop-blur-lg border-b border-slate-800">
        <nav className="container mx-auto px-4 sm:px-6 py-1 sm:py-2">
          <div className="flex justify-between items-center min-h-[40px] sm:min-h-[48px]">
            ...
            <Link to="/" className="flex items-center flex-shrink-0 h-8 sm:h-10 overflow-hidden">
              <img 
                src="/logo.png" 
                alt="CallitDNS" 
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-400">
                ...
                <li><Link to="/contact?type=sales" className="hover:text-amber-400 transition">Sales</Link></li>
                <li><a href="mailto:hello@callitdns.com" className="hover:text-amber-400 transition">Support</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-400">
                ...
                <li><Link to="/cancellation" className="hover:text-amber-400 transition">Cancellation Policy</Link></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-slate-800 pt-8 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            ...
            <div className="flex items-center space-x-4">
              <a href="tel:703-831-7181" className="text-slate-400 hover:text-amber-400 text-sm transition">
                703-831-7181
              </a>
              <span className="text-slate-600">•</span>
              <a href="mailto:hello@callitdns.com" className="text-slate-400 hover:text-amber-400 text-sm transition">
                hello@callitdns.com
              </a>
            </div>
          </div>
