...
export const runHealthScan = async (domain) => {
  ...
  try {
    ...
    if (
      ...
      console.log(
        "Auth error detected, trying complete sign-out/sign-in cycle..."
      );
      ...
      try {
        ...
        throw new Error(
          "Authentication failed. Please sign out completely and sign back in."
        );
      }
    }
    ...
    if (error.code === "functions/invalid-argument") {
      throw new Error(
        "Invalid domain provided. Please check the domain name and try again."
      );
    }
